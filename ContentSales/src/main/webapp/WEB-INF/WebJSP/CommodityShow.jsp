...
<body>
    ...
    <div class="g-doc">
        <div class="m-tab m-tab-fw m-tab-simple f-cb">
            <div class="tab">
                <ul>
                    <li class="z-sel"><a href="/ContentSales/queryForShow">所有内容</a></li>
                    <li ><a href="/ContentSales/queryForNotBuy">未购买的内容</a></li>
                </ul>
            </div>
        </div>
        <div class="n-plist">
            <ul class="f-cb" id="plist">
                ...
                <c:forEach items="${commodityBuyMap}" var="Commodity">
                    <li id="p-${Commodity.id}"><a href="/ContentSales/CommodityDetailForBuy?id=${Commodity.id}" class="link">
                            <div class="img">
                                <img src="${Commodity.url}" alt="${Commodity.title}">
                            </div>
