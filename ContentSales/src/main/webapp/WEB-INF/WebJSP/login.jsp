...
<form:form method="POST" modelAttribute="user" action="loginAction"  class="m-form m-form-ht n-login" id="loginForm" onsubmit="return false;" name="loginForm" autocomplete="off" >
    <div class="fmitem">
