        ...
        <div class="n-public">
            <form id="commodityform" name="commodityform" method="POST"
                ...
                <div class="fmitem">
                    ...
                    <div class="fmipt">
                        <input id="title" class="u-ipt ipt" name="title" path="title" value="${commodity.title}"
                            placeholder="2-80字符" /> 
                ...
                <div class="fmitem">
                    ...
                    <div class="fmipt">
                        <input id="summary"  class="u-ipt ipt" path="summary" name="summary" value="${commodity.summary}"
                            placeholder="2-140字符" />
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input id="urlText" class="u-ipt ipt" path="url" name="url" value="${commodity.url}" placeholder="图片地址"/>
                </div>
                ...
                <div class="fmitem">
                    ...
                    <div class="fmipt">
                        <textarea id="content" class="u-ipt" name="content" path="content" 
                            rows="10" placeholder="2-1000个字符">${commodity.content}</textarea>
                ...
                <div class="fmitem">
                    ...
                    <div class="fmipt">
                        <input id="price" class="u-ipt price" path="price" name="price" value="${commodity.price}" onblur="CheckNumLegal()"/>元
                ...
                <div class="fmitem fmitem-nolab fmitem-btn">
                    <div class="fmipt">
                        <button id="btone" type="submit"
                            class="u-btn u-btn-primary u-btn-lg" onClick="checkAndSubmit()">更新</button>
                    </div>
                </div>
            </form>
            <span class="imgpre">
            <img src="${commodity.url}" alt="" id="imgpre"></span>
        </div>
    </div>
    <div class="n-foot">
        <p>
