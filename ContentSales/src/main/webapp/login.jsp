...
<form class="m-form m-form-ht n-login" id="loginForm" name="loginForm" method="post" action="LoginAction_Login" onsubmit="return false;" autocomplete="off" >
    <div class="fmitem">
        <label class="fmlab">用户名：</label>
        <div class="fmipt">
            <input class="u-ipt" type="username" name="username" id="username"/>
        </div>
    </div>
    <div class="fmitem">
        <label class="fmlab">密码：</label>
        <div class="fmipt">
            <input id="password" class="u-ipt" type="password" name="password"/>
